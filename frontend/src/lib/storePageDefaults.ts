...
export const DEFAULT_PUBLIC_STORE_PAGES: Record<
  StorePageSlug,
  StorePagePublicDto
> = {
  about: {
    ...
    contentJson: {
      ...
      heroDescription:
        "We focus on products that feel useful, reliable, and easy to welcome into everyday routines.",
      badges: [
        {
          title: "Carefully chosen",
          description:
            "We aim to offer products that are useful, enjoyable, and suitable for a wide range of customers. Every item should have a clear reason to be in the store.",
        },
        {
          title: "Simple and honest",
          description:
            "We believe shopping should feel straightforward. Clear product information, transparent communication, and reliable service are part of the experience.",
        },
        {
          title: "Mindful approach",
          description:
            "Sustainability and creativity matter to us. We value thoughtful choices, long-lasting usefulness, and products that are not only attractive but also practical.",
        },
      ],
      secondaryTitle: "A better everyday shopping experience.",
      secondaryBody:
        "As the catalog grows, the goal stays the same: offer products with a clear purpose and support customers with straightforward service.",
      finalTitle: "Thank you for supporting our shop.",
      finalBody:
        "Every order helps keep the store focused on quality, clarity, and thoughtful service.",
    } satisfies AboutPageContentDto,
    closingNote: null,
  },
  contact: {
    slug: "contact",
    ...
    } satisfies ContactPageContentDto,
    closingNote: "Answered as soon as possible.",
  },
  faq: {
    slug: "faq",
    ...
    contentJson: {
      intro:
        "Here are answers to common questions about ordering, delivery, payments, refunds, and contacting our shop.",
      items: [
        {
          question: "How do I place an order?",
          answer:
            "Browse our products, add the items you want to your cart, and continue to checkout. At checkout, enter your contact and delivery details, then complete payment using the available secure payment method.",
        },
        {
          question: "Do I need an account to order?",
          answer:
            "No. Orders are placed as a guest. We only ask for the information needed to process your order, deliver your products, and contact you about your purchase.",
        },
        {
          question: "How long does delivery take?",
          answer:
            "Orders are usually processed within 1-2 business days. Delivery typically takes 3-7 business days after processing, depending on the delivery method and destination.",
        },
        {
          question: "Can I cancel my order myself?",
          answer:
            "No. If there is a problem with your order, please contact support as soon as possible. Cancellation and refund requests are handled through customer support and reviewed case by case.",
        },
        {
          question: "When can I request a refund?",
          answer:
            "Refunds may be considered if the product is damaged, incorrect, not delivered, or unavailable because of a stock issue. Change of mind is not normally accepted as a refund reason.",
        },
        {
          question: "How long do I have to report an issue?",
          answer:
            "Please contact us within 14 days of receiving your order, or within 14 days of the expected delivery period if the order was not delivered. Requests made after this period may not be accepted.",
        },
        {
          question: "Do I need to return a product before receiving a refund?",
          answer:
            "In most cases, yes. Products must usually be returned before a refund is issued. Returned items should be unused and in reasonable condition unless the issue is related to damage or a defect.",
        },
        {
          question: "Who pays for return shipping?",
          answer:
            "Return shipping is usually paid by the customer, unless the return is caused by our mistake, such as sending the wrong product, or the product arrived damaged or defective.",
        },
        {
          question: "Are payments secure?",
          answer:
            "Yes. Payments are handled by a secure third-party payment provider. We do not store your card details on our own servers.",
        },
        {
          question: "How can I contact the shop?",
          answer:
            "You can contact us through the contact page or by using the support email shown on the website. Please include your order number if your message is related to an existing order.",
        },
      ],
    } satisfies FaqPageContentDto,
    closingNote:
  ...
  privacy: {
    ...
    contentJson: {
      intro:
        "This Privacy Policy explains how we collect, use, and protect your personal information when you use our store.",
      sections: [
        {
...
- Improving our store and services`,
    ...
    } satisfies PolicyPageContentDto,
    closingNote:
  ...
  terms: {
    ...
    contentJson: {
      intro:
        "These Terms & Conditions govern your use of our store and apply to all purchases made through the website.",
      sections: [
        {
          title: "General use",
  ...
  "cancellation-refund": {
    ...
    contentJson: {
      intro:
        "This policy explains how cancellations, returns, and refunds are handled for purchases made through our store.",
      sections: [
        {
...
Refunds are not normally provided for change of mind or general customer dissatisfaction unless the issue is connected to one of the valid refund reasons above.`,
  ...
  shipping: {
    ...
    contentJson: {
      intro:
        "This Shipping Policy explains how orders are processed, packed, shipped, and delivered after purchase.",
      sections: [
        {
