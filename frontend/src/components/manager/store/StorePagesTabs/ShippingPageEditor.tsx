...
export function ShippingPageEditor({
  form,
  fieldErrors,
  updateForm,
}: {
  ...
  return (
    <>
      <StoreFormCard
        ...
        description="The visible shipping-policy title and opening summary."
      >
        <TextField
          label="Title"
          value={form.title}
      ...
      <StoreFormCard
        ...
        description=" Add or refine the details customers should know about packing,
            dispatch, delivery timing, and shipping exceptions."
      >
      ...
      <StoreFormCard
        title="Shipping closing note"
        description="Optional closing copy shown after the main shipping-policy sections."
      >
        <TextareaField
          label="Closing note"
