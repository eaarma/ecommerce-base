...
export function TermsPageEditor({
  ...
  return (
    <>
      <StoreFormCard
        title="Terms header"
        description="The visible terms page title and opening summary."
      >
        <TextField
          label="Title"
          value={form.title}
      ...
      <StoreFormCard
        ...
        description="Structured sections for purchase terms, responsibilities, and storefront conditions."
      >
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <p className="text-sm text-base-content/60">
            Add or refine the rules, expectations, and conditions customers
            should understand before ordering.
          </p>
          <button
            type="button"
      ...
      <StoreFormCard
        title="Terms closing note"
        description="Optional closing copy shown after the main terms sections."
      >
        <TextareaField
          label="Closing note"
