  ...
  return (
    <>
      <StoreFormCard
        ...
        description="The visible privacy-policy title and opening summary."
      >
        <TextField
          label="Title"
          value={form.title}
      ...
      <StoreFormCard
        ...
        description="Structured sections for data collection, usage, storage, cookies, and customer rights."
      >
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <p className="text-sm text-base-content/60">
            Add or refine the sections that explain how customer data is
      ...
      <StoreFormCard
        title="Privacy closing note"
        description="Optional closing copy shown after the main privacy-policy sections."
      >
        <TextareaField
          label="Closing note"
